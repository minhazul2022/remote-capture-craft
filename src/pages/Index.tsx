...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-hero flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="text-lg md:text-xl text-foreground max-w-3xl mx-auto space-y-6 text-left px-4">
          <p className="leading-relaxed font-medium">শিখুন, প্র্যাকটিস করুন এবং আয় করুন – এক জায়গায় সবকিছু!</p>
          
          <p className="leading-relaxed font-medium">📌 আমাদের টেলিগ্রাম গ্রুপে যা পাচ্ছেন একদম ফ্রি:</p>
          ...
          <p className="leading-relaxed font-medium">💰 লক্ষ্য: প্রতি মাসে ২০–৩০ হাজার টাকা আয়ের সুযোগ তৈরি করা</p>
          
          <p className="leading-relaxed font-medium">➡️ যারা ট্রেডিং শিখে নিজের আয় শুরু করতে চান, তাদের জন্য এটি সেরা জায়গা।</p>
          
          <p className="leading-relaxed font-medium">⚡️ টেলিগ্রাম গ্রুপে যোগ দিন এবং আপনার ট্রেডিং যাত্রা আজই শুরু করুন!</p>
        </div>
